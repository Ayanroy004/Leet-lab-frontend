...
function CreateProblemForm() {
  ...
  const onSubmit = async (value) => {
    try {
      ...
      toast.success(res.data.message || "Problem create successfully");
      navigation("/");
    } catch (error) {
      console.log(error);
  ...
  const loadSampleData = () => {
    ...
    tagsReplace(sampleData.tags.map((tag) => tag));
    testCaseReplace(sampleData.testcases.map((testcase) => testcase));
              ...
              <div className="join">
                <button
                  ...
                  className={`btn join-item ${
                    sampleType === "DP" ? "btn-active btn-primary" : ""
                  }`}
                ...
                <button
                  type="button"
                  className={`btn join-item ${
                    sampleType === "string" ? "btn-active btn-primary" : ""
                  }`}
            ...
            <div className="card bg-base-200 p-4 md:p-6 shadow-md">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  type="button"
                  className="btn btn-primary btn-sm"
                  onClick={() => testCaseAppend({ input: "", output: "" })}
                >
